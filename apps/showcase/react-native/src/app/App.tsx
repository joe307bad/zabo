...
import Styles, { ReactNativeStyles } from '@zabo/design/tailwind'
const App = () => {
  const [whatsNextYCoord, setWhatsNextYCoord] = useState<number>(0);
  const scrollViewRef = useRef<null | ScrollView>(null);
  const {tailwind, getColor} = create(ReactNativeStyles);
      ...
      <SafeAreaView>
        ...
        >
          <View style={styles.section}>
            <Text style={tailwind(Styles.Text.Variants.H1)}>
              Styles.Text.Variants.H1
            </Text>
            <Text style={styles.textLg}>Hello there,</Text>
            <Text style={[styles.textXL, styles.appTitleText]} testID="heading">
              Welcome ShowcaseReactNative 👋
            </Text>
          </View>
          <View style={styles.section}>
